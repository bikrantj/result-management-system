        ...
        <div class="modal-content rounded-2xl border-0 shadow-2xl overflow-hidden">
            ...
            <div class="modal-header bg-gradient-to-r from-blue-600 to-indigo-600 border-b-0 px-6">
                <div class="flex items-center justify-between w-full">
                    <div class="flex items-center gap-3">
                        <div>
                            <h5 class="modal-title text-xl font-bold text-white mb-0">Edit Teacher</h5>
            ...
            <form method="post" action="${pageContext.request.contextPath}/admin/teachers/">
                <div class="modal-body space-y-5 p-6 bg-gradient-to-b from-white to-gray-50/30">
                    ...
                    <div>
                        ...
                        <div class="relative">
                            <input type="text" name="fullName" id="editName"
                                   ...
                                   placeholder="Enter teachers's full name">
                            <div class="absolute inset-y-0 right-0 pr-3 flex items-center pointer-events-none">
                                <svg class="w-5 h-5 text-gray-400" fill="none" stroke="currentColor"
                                     viewBox="0 0 24 24">
                                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                    ...
                    </div> <!-- Subject Dropdown -->
                    <div>
                        <label for="editSubject" class="block text-sm font-medium text-gray-700 mb-2">
                            Subject
                        </label>
                        <div class="relative">
                            <select name="subjectId" id="editSubject"
                                    class="w-full px-4 py-3 border border-gray-200 rounded-xl
                                           focus:outline-none focus:ring-2 focus:ring-blue-500
                                           focus:border-transparent transition-all duration-200
                                           bg-white appearance-none cursor-pointer
                        ...
                        <p class="text-xs text-gray-500 mt-2 ml-1">Select semester first to load subjects</p>
                    </div>
